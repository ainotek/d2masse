                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <button type="button" class="btn btn-outline-primary float-right ml-3"><i
                                                class="icon-cloud-download"></i> &nbsp; Download
                                        </button>
                                ...
                                <table class="table table-responsive-sm table-hover table-outline mb-0">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar">
                                                <img src="{{asset('img/avatars/1.jpg')}}" class="img-avatar"
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/us.png')}}" alt="USA" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/bz.png')}}" alt="Brazil" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="float-left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/ca.png')}}" alt="Canada" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="float-left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/fr.png')}}" alt="France" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="float-left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/sp.png')}}" alt="Spain" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="float-left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset('img/flags/uk.png')}}" alt="United Kingdom" style="height:24px;">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="float-left">
